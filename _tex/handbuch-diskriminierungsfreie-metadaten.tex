...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, toprule=.15mm, leftrule=.75mm, opacityback=0, toptitle=1mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, toprule=.15mm, leftrule=.75mm, opacityback=0, toptitle=1mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, toprule=.15mm, leftrule=.75mm, opacityback=0, toptitle=1mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm]
