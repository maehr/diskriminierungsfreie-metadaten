...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, rightrule=.15mm, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, left=2mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, rightrule=.15mm, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-important-color-frame, left=2mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, rightrule=.15mm, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, left=2mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, opacityback=0]
