...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, bottomrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, left=2mm]
