...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colframe=quarto-callout-warning-color-frame, coltitle=black, toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, toptitle=1mm, breakable, colback=white, opacityback=0, arc=.35mm, rightrule=.15mm]
