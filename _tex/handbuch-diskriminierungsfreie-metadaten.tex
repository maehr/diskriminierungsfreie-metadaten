...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, leftrule=.75mm, colback=white, coltitle=black, rightrule=.15mm, toprule=.15mm, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, bottomtitle=1mm, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, breakable, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, leftrule=.75mm, colback=white, coltitle=black, rightrule=.15mm, toprule=.15mm, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, bottomtitle=1mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, breakable, opacitybacktitle=0.6]
