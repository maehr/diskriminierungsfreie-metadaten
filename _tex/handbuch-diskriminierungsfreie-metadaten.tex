...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, toptitle=1mm, leftrule=.75mm, toprule=.15mm, left=2mm, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, toptitle=1mm, leftrule=.75mm, toprule=.15mm, left=2mm, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, colbacktitle=quarto-callout-tip-color!10!white]
