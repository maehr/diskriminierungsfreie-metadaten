...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toprule=.15mm, colback=white, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, opacityback=0, toptitle=1mm, breakable, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, coltitle=black, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toprule=.15mm, colback=white, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, opacityback=0, toptitle=1mm, breakable, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, coltitle=black, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white]
