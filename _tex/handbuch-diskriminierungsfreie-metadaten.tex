...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colback=white, colbacktitle=quarto-callout-warning-color!10!white, breakable, rightrule=.15mm, coltitle=black, toprule=.15mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, left=2mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, opacityback=0, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, colback=white, colbacktitle=quarto-callout-tip-color!10!white, breakable, rightrule=.15mm, coltitle=black, toprule=.15mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, left=2mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, opacityback=0, leftrule=.75mm]
