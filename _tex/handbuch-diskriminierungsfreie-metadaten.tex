...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Überarbeitung des Handbuchs}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

Das Handbuch wird derzeit umfassend überarbeitet, neu strukturiert und
erweitert. Eine Vorabversion ist hier verfügbar:
\href{https://moritz-maehr.quarto.pub/diskriminierungssensible-metadatenpraxis/}{Diskriminierungssensible
Metadatenpraxis}. Die finale Fassung erscheint voraussichtlich im
Frühjahr 2026.

Seit der Erstveröffentlichung im Juni 2024 haben wir zahlreiche
Rückmeldungen und Ergänzungen aufgenommen.\\
Feedback ist weiterhin willkommen -- kontaktieren Sie die Autor*innen
per
...
\includegraphics[width=3.32in,height=0.98in]{handbuch-diskriminierungsfreie-metadaten_files/figure-latex/mermaid-figure-6.png}
...
\includegraphics[width=3.76in,height=3.49in]{handbuch-diskriminierungsfreie-metadaten_files/figure-latex/mermaid-figure-10.png}
...
\includegraphics[width=3.47in,height=3.27in]{handbuch-diskriminierungsfreie-metadaten_files/figure-latex/mermaid-figure-9.png}
...
\includegraphics[width=3.59in,height=2.31in]{handbuch-diskriminierungsfreie-metadaten_files/figure-latex/mermaid-figure-8.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0221}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0382}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0262}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2052}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.7082}}@{}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0125}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0215}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0294}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2276}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.7089}}@{}}
...
\includegraphics[width=10.17in,height=12.35in]{handbuch-diskriminierungsfreie-metadaten_files/figure-latex/mermaid-figure-7.png}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0783}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9217}}@{}}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

Die in diesem Kapitel gezeigten Beschreibungstexte und Metadaten sind
eine Momentaufnahme aus dem Projekt Stadt.Geschichte.Basel und befinden
sich in Überarbeitung. Sie sind daher nicht als
``Best-Practice''-Beispiele zu verstehen. Wir laden Sie ein, die
Beispiele kritisch zu betrachten und als Ausgangspunkt für Diskussionen
zu nutzen.
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image10.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0100}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9900}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image4.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0059}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9941}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image12.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0101}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9899}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image6.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0156}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9844}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image11.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0125}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9875}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image14.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0060}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image13.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0182}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9818}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image15.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0119}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9881}}@{}}
...
Die Aufteilung der Beispiele der Lebensbilder in ``positiv'' und
``negativ'' ist missverständlich und wird künftig aufgehoben.
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image8.jpg}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0171}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9829}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image2.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0252}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9748}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image1.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0108}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9892}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image3.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0279}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9721}}@{}}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image5.png}
...
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{media/image9.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0186}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9814}}@{}}
...
Australian Research Data Commons (ARDC). 2020. \emph{{ARDC Metadata
Guide}}. März 1. \url{https://doi.org/10.5281/ZENODO.6459832}.

\bibitem[\citeproctext]{ref-baca2016}
Baca, Murtha. 2016. \emph{Introduction to Metadata}. 3. Aufl.
Herausgegeben von Murtha Baca. Getty Publications.
...
Mounier. OpenEdition Press.
\url{https://doi.org/10.4000/books.oep.9024}.

\bibitem[\citeproctext]{ref-sgg2023}
Gabay, Simon, Tobias Hodel, Moritz Mähr, u.~a. 2023. {«Datenstandards
Für Die Historische {Forschung} -- {Ein White-Paper} Der
{Schweizerischen Gesellschaft} Für {Geschichte}»}. \emph{Whitepaper},
Online-Vorab-Publikation, November 10.
...
Heinrich, Andreas, und Anita Runge. 2018. \emph{GenderOpen: Ein
Repositorium für die Geschlechterforschung}.
\url{https://doi.org/10.25595/584}.
...
bibliotheks- und informationswissenschaft 481. Institut für Bibliotheks-
...
Staunton, Ciara, Carlos Andrés Barragán, Stefano Canali, u.~a. 2021.
{«Open Science, Data Sharing and Solidarity: Who Benefits?»}
\emph{History and Philosophy of the Life Sciences} 43 (4): 115.
\url{https://doi.org/10.1007/s40656-021-00468-6}.
...
The Turing Way Community. 2022. \emph{The {Turing Way}: {A} Handbook for
Reproducible, Ethical and Collaborative Research}. Version 1.0.2.
Released Juli 27. \url{https://doi.org/10.5281/ZENODO.3233853}.

\bibitem[\citeproctext]{ref-wilkinson2016}
Wilkinson, Mark D., Michel Dumontier, IJsbrand Jan Aalbersberg, u.~a.
...
Das Mapping wird demnächst aktualisiert, da seit der Publikation des
Handbuchs neue Begriffe in den GND aufgenommen worden sind.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1171}}
