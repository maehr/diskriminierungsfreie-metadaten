...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, opacityback=0, titlerule=0mm, left=2mm, leftrule=.75mm, coltitle=black, breakable, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, colback=white, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, opacityback=0, titlerule=0mm, left=2mm, leftrule=.75mm, coltitle=black, breakable, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, colback=white, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, colbacktitle=quarto-callout-tip-color!10!white]
