...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, left=2mm, breakable, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, toptitle=1mm, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, left=2mm, breakable, bottomtitle=1mm, coltitle=black, opacitybacktitle=0.6, leftrule=.75mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, toptitle=1mm, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, rightrule=.15mm]
