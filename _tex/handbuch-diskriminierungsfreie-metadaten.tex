...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, coltitle=black, bottomtitle=1mm, breakable, opacitybacktitle=0.6, opacityback=0, titlerule=0mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, colback=white, toptitle=1mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, arc=.35mm, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, coltitle=black, bottomtitle=1mm, breakable, opacitybacktitle=0.6, opacityback=0, titlerule=0mm, colframe=quarto-callout-tip-color-frame, toprule=.15mm, colback=white, toptitle=1mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, arc=.35mm, rightrule=.15mm, bottomrule=.15mm]
