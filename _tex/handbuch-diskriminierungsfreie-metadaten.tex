...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, opacityback=0, colback=white, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, breakable, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacityback=0, colback=white, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, breakable, colframe=quarto-callout-important-color-frame, rightrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, breakable, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, arc=.35mm]
