...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, opacityback=0, breakable, opacitybacktitle=0.6, left=2mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, opacityback=0, breakable, opacitybacktitle=0.6, left=2mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, rightrule=.15mm]
