...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, titlerule=0mm, opacityback=0, coltitle=black, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, left=2mm, toprule=.15mm]
