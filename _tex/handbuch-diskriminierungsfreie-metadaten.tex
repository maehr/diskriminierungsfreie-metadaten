...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, rightrule=.15mm, titlerule=0mm, colback=white, opacitybacktitle=0.6, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, breakable, leftrule=.75mm, left=2mm, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, rightrule=.15mm, titlerule=0mm, colback=white, opacitybacktitle=0.6, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, breakable, leftrule=.75mm, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm]
