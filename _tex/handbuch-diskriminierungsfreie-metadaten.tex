...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, rightrule=.15mm, colback=white, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, colframe=quarto-callout-warning-color-frame, coltitle=black, left=2mm, opacityback=0, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, rightrule=.15mm, colback=white, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, opacityback=0, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, rightrule=.15mm, colback=white, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, opacityback=0, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm]
