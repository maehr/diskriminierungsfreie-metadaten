...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, coltitle=black, breakable, toprule=.15mm, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, left=2mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, coltitle=black, breakable, toprule=.15mm, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, left=2mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, coltitle=black, breakable, toprule=.15mm, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, left=2mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, opacityback=0]
