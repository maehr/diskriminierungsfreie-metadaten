...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, colframe=quarto-callout-warning-color-frame, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, arc=.35mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, coltitle=black, colback=white, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, arc=.35mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, coltitle=black, colback=white, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6]
