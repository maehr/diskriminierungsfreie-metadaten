...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, colback=white, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, leftrule=.75mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, coltitle=black, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, colback=white, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, leftrule=.75mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, coltitle=black, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6]
