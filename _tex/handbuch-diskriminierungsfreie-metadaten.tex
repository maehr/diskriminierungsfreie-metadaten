...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-warning-color-frame, breakable, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, titlerule=0mm, opacityback=0, arc=.35mm, rightrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-tip-color-frame, breakable, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, titlerule=0mm, opacityback=0, arc=.35mm, rightrule=.15mm, leftrule=.75mm]
