...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomtitle=1mm, opacityback=0, colback=white, breakable, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomtitle=1mm, opacityback=0, colback=white, breakable, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Überarbeitung des Handbuchs}, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, arc=.35mm, toprule=.15mm]

Das Handbuch wird derzeit umfassend überarbeitet, neu strukturiert und
erweitert. Eine Vorabversion ist hier verfügbar:
\href{https://moritz-maehr.quarto.pub/diskriminierungssensible-metadaten/}{Diskriminierungssensible
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomtitle=1mm, opacityback=0, colback=white, breakable, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomtitle=1mm, opacityback=0, colback=white, breakable, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Hinweis zur anstehenden Überarbeitung des Handbuchs}, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, arc=.35mm, toprule=.15mm]
