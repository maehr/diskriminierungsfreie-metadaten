...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, breakable, titlerule=0mm, arc=.35mm, colback=white, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, left=2mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, breakable, titlerule=0mm, arc=.35mm, colback=white, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm]
