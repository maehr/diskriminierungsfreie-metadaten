...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toptitle=1mm, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, colback=white, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, breakable, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toptitle=1mm, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, colback=white, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, breakable, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm]
