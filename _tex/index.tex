...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, colframe=quarto-callout-warning-color-frame, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, rightrule=.15mm, breakable, bottomtitle=1mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, coltitle=black, arc=.35mm, bottomrule=.15mm, colback=white]
...
\includegraphics[width=2.85in,height=0.8in]{index_files/figure-latex/mermaid-figure-6.png}
...
\includegraphics[width=3.3in,height=3.33in]{index_files/figure-latex/mermaid-figure-10.png}
...
\includegraphics[width=3in,height=3.11in]{index_files/figure-latex/mermaid-figure-9.png}
...
\includegraphics[width=3.13in,height=1.79in]{index_files/figure-latex/mermaid-figure-8.png}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0165}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0259}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.6792}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Name}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\item
  ...
  \tightlist
  \item
    Typisches vollständiges Datum, JJJJ-MM-TT, muss führende Nullen an
...
\item
  ...
  \tightlist
  \item
    Nur für den Monat angegeben; "irgendwann im März 2014".
  \end{itemize}
\item
  2014
  ...
  \tightlist
  \item
    Nur für das Jahr angegeben; "irgendwann im Jahr 2014".
  \end{itemize}
\item
  2014-21
  ...
  \tightlist
  \item
    Jahreszeit (nördliche Hemisphäre): 21=Frühling, 22=Sommer,
    23=Herbst, 24=Winter
  \end{itemize}
\item
  2014\textasciitilde{}
  ...
  \tightlist
  \item
    Ungefähres Datum: "Ungefähr 2014". Die genaue Interpretation von
    "ungefähr" ist nicht spezifiziert, aber +/- 2 der genauesten
    angegebenen Einheiten (in diesem Beispiel Jahre) ist eine
...
\item
  ...
  \tightlist
  \item
    Ungewisses Datum: "Vielleicht 2014." Die Alternative könnte alles
    andere sein. Bitte gehe sparsam damit um, denn das "alles andere"
    ist unerwünscht. Wenn eine Vorstellung von einem Bereich möglicher
    Daten besteht, kann die Bereichsform verwendet werden.
  \end{itemize}
\item
  {[}2012,2014{]}
...
\item
  ...
  \tightlist
  \item
    Unbestimmte Ziffer(n) von rechts: Das Zeichen "X" kann anstelle
    einer oder mehrerer Ziffern ganz rechts verwendet werden, um
    anzuzeigen, dass der Wert dieser Ziffer in den folgenden Fällen
    nicht spezifiziert ist: Eine Jahreszahl mit einer oder zwei (ganz
    rechts) nicht spezifizierten Ziffern in einem reinen Jahresausdruck
    (Jahresgenauigkeit)
  \end{itemize}
\end{itemize}
...
\item
  ...
  \tightlist
  \item
    Bereich des ungewissen Datums: "Irgendwann zwischen dem 3. Januar
    und dem 15. April 2014." Beachte, dass genau zwei Zeiträume zwischen
    den Daten liegen. Dies ist die bevorzugte Form für unbestimmte
    Daten, da sie für den Computer am einfachsten zu verarbeiten ist.
    NICHT ein Intervall gültiger Daten ("im Zeitraum vom 3. Januar bis
    15. April 2014"); das wird als separates Start- und Enddatum
    eingegeben.
  \end{itemize}
\item
  {[}..2014-04-15{]}
  ...
  \tightlist
  \item
    Unbegrenzter Bereich mit ungewissem Datum: "Irgendwann vor dem 15.
    April 2014". Wenn du also eine Vorstellung vom Beginn des
    Zeitfensters hast, gib es bitte ein.
  \end{itemize}
\item
  {[}2014-04-15..{]}
  ...
  \item
    ...
    2014". Das System interpretiert dies als einen Zeitpunkt zwischen
    diesem Datum und heute. Wenn du also eine Vorstellung vom Ende des
    Zeitfensters hast, gib es bitte ein.
  \end{itemize}
\item
  unknown
  ...
  \tightlist
  \item
    Das Datum ist völlig unbekannt, aber es ist bekannt, dass das
    Ereignis an einem bestimmten Datum stattfindet. Wir wissen z.B.,
    dass die Organisation eines Zweigs an einem bestimmten Tag
    stattgefunden haben muss, aber wir haben keine Ahnung, wann dieser
    Tag war. Bitte gehe sparsam damit um, denn das System kann daraus
    nichts abschätzen; wenn du eine Vorstellung von einem bestimmten
...
\texttt{\{=html\}\ \ \textless{}!-\/-\ -\/-\textgreater{}} \textbar{} -
...
\includegraphics[width=6.62in,height=7.23in]{index_files/figure-latex/mermaid-figure-7.png}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, rightrule=.15mm, breakable, bottomtitle=1mm, toptitle=1mm, left=2mm, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, coltitle=black, arc=.35mm, bottomrule=.15mm, colback=white]
...
historische Nachschlagewerke wie dem
\href{https://www.baslerstadtbuch.ch/home.html}{Basler Stadtbuch} oder
dem \href{https://hls-dhs-dss.ch/}{Historische Lexikon der Schweiz}. Um
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0158}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9842}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
Beratungsstelle hatte eugenische Motiv. Die Absicht bestand darin, nicht
nur über Verhütung aufzuklären, sondern auch Eheanwärter*innen~in
...
License & \url{http://rightsstatements.org/vocab/InC/1.0/} \textbar{} \\
\end{longtable}
...
Format & image/jpeg \\
Extent & 703 x 1000 \\
Source & Landesamt für Denkmalpflege im Regierungspräsidium
Stuttgart/Samson Götze \\
Language & \\
Relation &
...
Language & \\
Relation & \url{https://archiv.ub.uni-heidelberg.de/artdok/8148/} \\
...
\begin{itemize}
\item
  Auf Lebensbildern wird oftmals das Bild einer Kernfamilie dargestellt.
  Diese Kernfamilie entspricht dem heutigen stereotypen Familienideal,
  das aus Vater, Mutter und zwei Kindern besteht. Zudem sind Kinder auf
  Lebensbildern grundsätzlich unterrepräsentiert. Wenn sie wie im
  folgenden Beispiel vorhanden sind, nehmen sie die Rolle von
  Statist*innen ein. Sie spielen, essen oder beobachten die Arbeiten der
  Erwachsenen.
\item
  ...
  nur die beiden biologischen Geschlechter ``Mann'' und ``Frau'' und
  keine sozialen Geschlechter sowie keine intersexuellen Individuen,
  obschon es all dies gab.
\item
...
\item
  Menschen in der Ur- und Frühgeschichte werden in vielen Lebensbildern
  normal- beziehungsweise~idealgewichtig dargestellt, obwohl sowohl
  anthropologische Untersuchungen als auch Trachtbestandteile wie sehr
  breite Gürtel dieses Bild widerlegen.
\item
