...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, left=2mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colback=white, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, breakable, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, toptitle=1mm, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, left=2mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colback=white, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, breakable, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, toptitle=1mm, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
