...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, coltitle=black, arc=.35mm, colback=white, opacityback=0, rightrule=.15mm, leftrule=.75mm, titlerule=0mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, coltitle=black, arc=.35mm, colback=white, opacityback=0, rightrule=.15mm, leftrule=.75mm, titlerule=0mm, left=2mm]
