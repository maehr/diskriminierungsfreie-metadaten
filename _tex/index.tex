...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colframe=quarto-callout-warning-color-frame, colback=white, opacityback=0, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, breakable]
