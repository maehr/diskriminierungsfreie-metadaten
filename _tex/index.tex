...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, toprule=.15mm, coltitle=black, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, arc=.35mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, colback=white]
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0220}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0379}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.7106}}@{}}
...
Römische Zeit und Spätantike- Mittelalter- Neuzeit- ZeitgeschichteAuf
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0156}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0270}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0369}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2855}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.6349}}@{}}
...
& & & & Liste der wichtigsten Institutionen in Basel \\
& & & & \\
...
& & & & - 2014\textasciitilde{} - Ungefähres Datum: ``Ungefähr 2014''.
Die genaue Interpretation von ``ungefähr'' ist nicht spezifiziert, aber
+/- 2 der genauesten angegebenen Einheiten (in diesem Beispiel Jahre)
...
& & & & - 2XXX - Unbestimmte Ziffer(n) von rechts: Das Zeichen ``X''
kann anstelle einer oder mehrerer Ziffern ganz rechts verwendet werden,
um anzuzeigen, dass der Wert dieser Ziffer in den folgenden Fällen nicht
spezifiziert ist: \\
& & & & - Beispiel 1 `201X' \\
& & & & - Beispiel 2 `20XX' \\
& & & & Jahr angegeben, Monat unspezifiziert in einem
Jahr-Monat-Ausdruck (Monatsgenauigkeit) \\
& & & & - Beispiel 3 `2004-XX' \\
...
& & & & - {[}..2014-04-15{]} - Unbegrenzter Bereich mit ungewissem
Datum: ``Irgendwann vor dem 15. April 2014''. Wenn du also eine
...
& & & & - `Event' Eine zeitliche Entität, die durch einen festen
Zeitpunkt oder ein Intervall im Zeitverlauf gekennzeichnet ist. \\
& & & & - `Image' Eine visuelle Darstellung, die nicht primär für
Kommunikation über Text hinausgeht. \\
& & & & - `Interactive Resource' Eine Ressource, die eine Interaktion
mit dem Benutzer erfordert, um ihren Zweck zu erfüllen. \\
& & & & - `Moving Image' Eine Serie von visuellen Darstellungen, die
eine Illusion von Bewegung erzeugen, wenn sie in schneller Abfolge
gezeigt werden. \\
...
& & & & - `Sound' Eine Ressource, die primär für die Wahrnehmung durch
das Ohr bestimmt ist. \\
...
genannt wird. \\
& & & & - `\url{https://creativecommons.org/licenses/by-sa/4.0/}' CC
...
& & & & - `\url{http://rightsstatements.org/vocab/InC/1.0/}' In
Copyright. Das Werk ist urheberrechtlich geschützt. \\
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, toprule=.15mm, coltitle=black, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, arc=.35mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, colback=white]
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0259}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9741}}@{}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0399}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9601}}@{}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0312}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9688}}@{}}
