...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, coltitle=black, opacityback=0, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warnung}, breakable, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm]
...
Kontexten ermöglichen.\footnote{Neben Open und FAIR Data gibt es eine
  ...
  Inhalte. Das \href{https://5stardata.info/}{5-Sterne-Open-Data-Modell}
...
\section{Metadaten der
Stadt.Geschichte.Basel}\label{metadaten-der-stadt.geschichte.basel}
...
\subsubsection{1. Ein Metadatenobjekt mit einer zugeordneten
Ressource}\label{ein-metadatenobjekt-mit-einer-zugeordneten-ressource}

\includegraphics[width=2.77in,height=0.78in]{index_files/figure-latex/mermaid-figure-6.png}

\textsubscript{Quelle:
\href{https://maehr.github.io/diskriminierungsfreie-metadaten/index.qmd.html}{Artikel-Notizbuch}}

Dieses Diagramm zeigt, dass ein Metadatenobjekt (Abbildung 13) eine
zugeordnete Ressource hat, nämlich ein Portrait.

\subsubsection{2. Ein Metadatenobjekt mit drei zugeordneten Ressourcen
(Triptychon)}\label{ein-metadatenobjekt-mit-drei-zugeordneten-ressourcen-triptychon}

\includegraphics[width=3.21in,height=3.3in]{index_files/figure-latex/mermaid-figure-10.png}
...
\subsubsection{3. Ein Metadatenobjekt mit drei verschiedenen
zugeordneten
Ressourcen}\label{ein-metadatenobjekt-mit-drei-verschiedenen-zugeordneten-ressourcen}

\includegraphics[width=2.96in,height=3.09in]{index_files/figure-latex/mermaid-figure-9.png}
...
\subsubsection{4. Zwei Metadatenobjekte mit derselben zugeordneten
Ressource}\label{zwei-metadatenobjekte-mit-derselben-zugeordneten-ressource}

\includegraphics[width=3.07in,height=1.75in]{index_files/figure-latex/mermaid-figure-8.png}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0475}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2494}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.6105}}@{}}
\toprule\noalign{}
...
oder bibliografische Angaben (nach Infoclio Zitierstandard), mehrere
Verweise können angegeben werden \\
\end{longtable}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0161}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0254}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0334}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.2353}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.6644}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.0208}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\multirow{2}{=}{\begin{minipage}[t]{\linewidth}\raggedright
\section{\texorpdfstring{\textbf{Name}}{Name}}\label{name}

MediaID
\end{minipage}} &
\multirow{2}{=}{\begin{minipage}[t]{\linewidth}\raggedright
\section{\texorpdfstring{\textbf{Dublin
Core}}{Dublin Core}}\label{dublin-core}

dcterms:identifier
\end{minipage}} &
\multirow{2}{=}{\begin{minipage}[t]{\linewidth}\raggedright
\section{\texorpdfstring{\textbf{Obligatorisch}}{Obligatorisch}}\label{obligatorisch}

Ja
\end{minipage}} &
\multirow{2}{=}{\begin{minipage}[t]{\linewidth}\raggedright
\section{\texorpdfstring{\textbf{Verwendung}}{Verwendung}}\label{verwendung}

Eine eindeutige Zeichenfolge ohne Leer- oder Sonderzeichen, die auf der
Website als ID verwendet wird.
\end{minipage}} &
\multirow{2}{=}{\begin{minipage}[t]{\linewidth}\raggedright
\section{\texorpdfstring{\textbf{Datenwertstandard}}{Datenwertstandard}}\label{datenwertstandard}
...
Infoclio Zitierstandard), mehrere Verweise können angegeben werden & \\
...
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.6851} + 2\tabcolsep}@{}}{%
\href{https://www.loc.gov/standards/datetime/}{Extended Date/Time Format
(EDTF)} \textbar{} \textbar{} - 2014-03-05 \textbar{} \textbar{} -
Typisches vollständiges Datum, JJJJ-MM-TT, muss führende Nullen an Monat
und Tag enthalten \textbar{} \textbar{} - 2014-03 \textbar{} \textbar{}
- Nur für den Monat angegeben; "irgendwann im März 2014". \textbar{}
\textbar{} - 2014 \textbar{} \textbar{} - Nur für das Jahr angegeben;
"irgendwann im Jahr 2014". \textbar{} \textbar{} - 2014-21 \textbar{}
\textbar{} - Jahreszeit (nördliche Hemisphäre): 21=Frühling, 22=Sommer,
23=Herbst, 24=Winter \textbar{} \textbar{} - 2014\textasciitilde{}
\textbar{} \textbar{} - Ungefähres Datum: "Ungefähr 2014". Die genaue
...
vernünftige Erwartung. \textbar{} \textbar{} - 2014? \textbar{}
\textbar{} - Ungewisses Datum: "Vielleicht 2014." Die Alternative könnte
...
Bereich möglicher Daten besteht, kann die Bereichsform verwendet werden.
\textbar{} - {[}2012,2014{]} \textbar{} \textbar{} - Eines der
angegebenen Daten. \textbar{} \textbar{} - ~2XXX \textbar{} \textbar{} -
Unbestimmte Ziffer(n) von rechts: Das Zeichen "X" kann anstelle einer
oder mehrerer Ziffern ganz rechts verwendet werden, um anzuzeigen, dass
der Wert dieser Ziffer in den folgenden Fällen nicht spezifiziert ist:
Eine Jahreszahl mit einer oder zwei (ganz rechts) nicht spezifizierten
Ziffern in einem reinen Jahresausdruck (Jahresgenauigkeit) \textbar{}
\textbar{} \textgreater{} Beispiel 1
\textquotesingle201X\textquotesingle~ \textbar{} \textgreater{} Beispiel
2 \textquotesingle20XX\textquotesingle~ \textbar{} \textgreater{} Jahr
angegeben, Monat unspezifiziert in einem Jahr-Monat-Ausdruck
(Monatsgenauigkeit)~ \textbar{} \textgreater{} Beispiel 3
\textquotesingle2004-XX\textquotesingle~ \textbar{} \textgreater{} Jahr
und Monat werden angegeben, der Tag wird in einem
Jahr-Monat-Tag-Ausdruck nicht angegeben (Tagesgenauigkeit)~ \textbar{}
\textgreater{} Beispiel 4 \textquotesingle1985-04-XX\textquotesingle{} ~
~ ~ ~ ~ ~ ~~~ \textbar{} \textgreater{} Jahr angegeben, Tag und Monat
nicht angegeben in einem Jahr-Monat-Tag-Ausdruck (Tagesgenauigkeit)~
\textbar{} \textgreater{} Beispiel 5
\textquotesingle1985-XX-XX\textquotesingle{} ~ \textbar{} \textbar{} -
{[}2014-01-03..2014-04-15{]} \textbar{} \textbar{} - Bereich des
ungewissen Datums: "Irgendwann zwischen dem 3. Januar und dem 15. April
2014." Beachte, dass genau zwei Zeiträume zwischen den Daten liegen.
Dies ist die bevorzugte Form für unbestimmte Daten, da sie für den
Computer am einfachsten zu verarbeiten ist. NICHT ein Intervall gültiger
Daten ("im Zeitraum vom 3. Januar bis 15. April 2014"); das wird als
separates Start- und Enddatum eingegeben. \textbar{} \textbar{} -
{[}..2014-04-15{]} \textbar{} \textbar{} - Unbegrenzter Bereich mit
ungewissem Datum: "Irgendwann vor dem 15. April 2014". Wenn du also eine
Vorstellung vom Beginn des Zeitfensters hast, gib es bitte ein.
\textbar{} \textbar{} - {[}2014-04-15..{]} \textbar{} \textbar{} -
Offener Bereich mit ungewissem Datum: "Irgendwann nach dem 15. April
2014". Das System interpretiert dies als einen Zeitpunkt zwischen diesem
Datum und heute. Wenn du also eine Vorstellung vom Ende des Zeitfensters
hast, gib es bitte ein. \textbar{} \textbar{} - unknown \textbar{}
\textbar{} - Das Datum ist völlig unbekannt, aber es ist bekannt, dass
das Ereignis an einem bestimmten Datum stattfindet. Wir wissen z.B.,
dass die Organisation eines Zweigs an einem bestimmten Tag stattgefunden
haben muss, aber wir haben keine Ahnung, wann dieser Tag war. Bitte gehe
sparsam damit um, denn das System kann daraus nichts abschätzen; wenn du
eine Vorstellung von einem bestimmten Datum hast, verwende das Formular
für den Zeitraum. \textbar{}} \\
Era & dcterms:temporal & Ja & Epoche (Frühgeschichte, Antike,
Mittelalter, Neuzeit, Zeitgeschichte) &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.6851} + 2\tabcolsep}@{}}{%
\begin{minipage}[t]{\linewidth}\raggedright
...
\tightlist
\item
  Ur- und Frühgeschichte \textbar{} \textbar{}
\item
  Römische Zeit und Spätantike \textbar{} \textbar{}
\item
  Mittelalter \textbar{} \textbar{}
\item
  Neuzeit \textbar{} \textbar{}
\item
  Zeitgeschichte \textbar{} \textbar{} Auf eine Spezifikation der
  \href{https://www.dublincore.org/specifications/dublin-core/dcmi-period/}{Epochen
  nach Dublin Core} wurde verzichtet, weil man sich zwischen den
  verschiedenen Disziplinen nicht auf einheitliche Perioden einigen
  konnte. \textbar{}
...
21535\_Plot\_OutputR-2.pdf & \begin{minipage}[t]{\linewidth}\raggedright
...
\href{https://rightsstatements.org/en/}{RightsStatements.org} \textbar{}
\textbar{} - \url{https://creativecommons.org/publicdomain/mark/1.0/}
\textbar{} \textbar{} - Public Domain Mark (PDM)
\href{https://creativecommons.org/public-domain/freeworks/}{\emph{\ul{Free
Culture}}} \textbar{} \textbar{} -
\url{https://creativecommons.org/publicdomain/zero/1.0/} \textbar{}
\textbar{} - CC0
\href{https://creativecommons.org/public-domain/freeworks/}{\emph{\ul{Free
Culture}}} \textbar{} \textbar{} -
\url{https://creativecommons.org/licenses/by/4.0/} \textbar{} \textbar{}
- CC BY (Attribution)
\href{https://creativecommons.org/public-domain/freeworks/}{\emph{\ul{Free
Culture}}} \textbar{} \textbar{} - Erlaubt anderen, das Werk zu
verbreiten, zu remixen, zu verändern und darauf aufzubauen, auch
kommerziell, solange der Urheber genannt wird. \textbar{} \textbar{} -
\url{https://creativecommons.org/licenses/by-sa/4.0/} \textbar{}
\textbar{} - CC BY-SA (Attribution-ShareAlike)
\href{https://creativecommons.org/public-domain/freeworks/}{\emph{\ul{Free
Culture}}} \textbar{} \textbar{} - Erlaubt anderen, das Werk zu remixen,
zu verändern und darauf aufzubauen, auch kommerziell, solange das neue
Werk unter der gleichen Lizenz veröffentlicht wird. \textbar{}
\textbar{} - \url{https://creativecommons.org/licenses/by-nc-sa/4.0/}
\textbar{} \textbar{} - CC BY-NC-SA
(Attribution-NonCommercial-ShareAlike) \textbar{} \textbar{} - Erlaubt
anderen, das Werk zu bearbeiten, solange es nicht kommerziell genutzt
wird und unter denselben Bedingungen weitergegeben wird. \textbar{}
\textbar{} - \url{http://rightsstatements.org/vocab/InC/1.0/} \textbar{}
\textbar{} - In Copyright. Das Werk ist urheberrechtlich geschützt.
\textbar{} \textbar{}
\texttt{\{=html\}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textbar{}\ \ \textless{}!-\/-\ -\/-\textgreater{}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textbar{}}
\textbar{} - \url{http://rightsstatements.org/vocab/InC-RUU/1.0/}
\textbar{} \textbar{} - In Copyright - Rights-holder(s) unlocatable or
unidentifiable \textbar{}} \\
\end{longtable}

\subsection{Relation von Objekt und
Media}\label{relation-von-objekt-und-media}

\includegraphics[width=6.57in,height=6.99in]{index_files/figure-latex/mermaid-figure-7.png}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, toptitle=1mm, coltitle=black, opacityback=0, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Erfahrungen der Stadt.Geschichte.Basel}, breakable, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm]
...
(siehe Fallbeispiel 2) die Information, wer das Plakat herstellte. In
solchen Fällen waren selbständige Recherchen oder eine Rücksprache mit
den jeweiligen Gedächtnisinstitutionen erforderlich.
...
Forschungsdatenplattform. Weil der Schlagwortindex-GenderOpen gezielt
sensible Schlagworte enthält, lassen sich Diskriminierungen in
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image10.jpg}

}

\caption{Das Bad zu Leuk}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0126}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9874}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
1926}\label{plakat-zur-vuxf6lkerschau-in-basel-1926}

\begin{figure}[H]

{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image4.png}

}

\caption{Plakat zur Völkerschau in Basel, 1926}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0073}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9927}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image12.jpg}

}

\caption{Schnitzerei am Chorgestühl des Basler Münsters}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image6.png}

}

\caption{Hie Basel Hie Schweizer Boden - Liste 3}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0196}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9804}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image11.png}

}

\caption{Zeitungsinserat in der National-Zeitung, 1955}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0158}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.9820}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0011}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
Description &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.9831} + 2\tabcolsep}@{}}{%
Seit 1933 wurde eine Ehe- und Sexualberatungsstelle vom Gesundheitsamt
Basel-Stadt eingerichtet. Neben individuellen Sprechstunden wurden auch
Ehekurse für Verlobte und Neuverheiratete angeboten. In diesen Kursen
wurden die Teilnehmenden in Bereichen wie Medizin, Hygiene, Psychologie
und Recht geschult. Die Gründung der Beratungsstelle hatte eugenische
Motive. Die Absicht bestand darin, nicht nur über Verhütung aufzuklären,
sondern auch Eheanwärter*innen~in zeitgenössischer Vererbungslehre zu
informieren. Solche eugenischen Ansätze gingen auch von leitenden Ärzten
...
License &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.9831} + 2\tabcolsep}@{}}{%
\url{http://rightsstatements.org/vocab/InC/1.0/} \textbar{}} \\
\end{longtable}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image14.jpg}

}

\caption{Die ausländische Wohnbevölkerung von Basel-Stadt nach
Heimatnation, 1920--1965}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0238}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9762}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image13.jpg}

}

\caption{Basler Brandmarkeisen, 17. Jahrhundert}

\end{figure}%

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0229}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9771}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image15.jpg}

}

\caption{Plan mit Verteilung jüdischer Häuser}

\end{figure}%

\includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image7.jpg}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0150}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9850}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Feldname}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image8.jpg}

}

\caption{Bestattung von Unlingen}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image2.png}

}

\caption{Höhlenleben zur älteren Steinzeit}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image1.png}

}

\caption{Bestattung von Bad Dürrenberg}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image3.png}

}

\caption{Opferplatz Thorberger Moor}
...
{\centering \includegraphics[width=0.8\textwidth,height=0.8\textheight]{media/image5.png}

}

\caption{Alle unter einem Dach}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2134}}
