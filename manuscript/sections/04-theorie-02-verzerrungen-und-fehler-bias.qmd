...
Erstens: Die Bias-Taxonomie in diesem Kapitel ist als **Diagnose- und Handlungsinstrument** gedacht. Sie hilft, Verzerrungen in Daten (zum Beispiel Auswahl- und Messfehler), in Algorithmen (zum Beispiel Evaluations- oder Optimierungsartefakte) und in Nutzerinteraktionen (zum Beispiel {{< glossary Ranking >}}- und Popularitätslogiken) zu lokalisieren und gezielt anzugehen.
