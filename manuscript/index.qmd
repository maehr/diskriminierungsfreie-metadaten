...
::: {#fig-metadata-1 fig-alt="Lineares Modell des Datenlebenszyklus mit sieben Phasen: Planung, Datensammlung, Verarbeitung, Speicherung, Veröffentlichung, Nachnutzung, Archivierung/Löschung."}
...
Darstellung des Datenlebenszyklus nach dem Curation Lifecycle Model (DCC), adaptiert in sieben linearen Phasen von der Planung bis zur Archivierung bzw. Löschung.
:::

<!-- ![Darstellung des Datenlebenszyklus nach dem Curation Lifecycle Model (DCC), adaptiert in sieben linearen Phasen von der Planung bis zur Archivierung bzw. Löschung.](images/image2.png){fig-alt="Lineares Modell des Datenlebenszyklus mit sieben Phasen: Planung, Datensammlung, Verarbeitung, Speicherung, Veröffentlichung, Nachnutzung, Archivierung/Löschung."} -->
...
Entscheidungshilfe zur Orientierung im Handbuch. Die Startfrage «Worum geht es konkret?» verzweigt in vier Pfade—Metadaten neu erstellen; Zugang/Präsentation verbessern; Bestehende Metadaten nachnutzen; Begriffe/Standards klären—mit Verweisen auf zugehörige Phasen, Praxisabschnitte und Checklisten.
:::

<!-- ![Entscheidungshilfe zur Orientierung im Handbuch. Die Startfrage «Worum geht es konkret?» verzweigt in vier Pfade—Metadaten neu erstellen; Zugang/Präsentation verbessern; Bestehende Metadaten nachnutzen; Begriffe/Standards klären—mit Verweisen auf zugehörige Phasen, Praxisabschnitte und Checklisten.](images/image3.png){fig-alt="Ein hellviolettes Flussdiagramm. In der Mitte eine rautenförmige Startbox mit dem Text «Worum geht es konkret?». Von dort führen vier Linien zu vier Themenkästen, von links nach rechts: Erstens «Metadaten neu erstellen». Darunter zwei Ebenen: «Phase 1 bis 3: Planung, Sammlung, Verarbeitung» und darunter «Praxis Paragraph 1 bis 3 sowie Checklisten B bis D». Zweitens «Zugang und Präsentation verbessern». Darunter «Phase 5: Veröffentlichung und Zugang» und darunter «Praxis Paragraph 5 sowie Checklisten F und K». Drittens «Bestehende Metadaten nachnutzen». Darunter «Phase 6: Nachnutzung und Wiederverwendung» und darunter «Praxis Paragraph 6 sowie Checkliste G». Viertens «Begriffe und Standards klären». Darunter «Theorie und Glossar» und darunter «Schlüsselbegriffe, Bias, FAIR und CARE». Die Kästen sind horizontal ausgerichtet, die Verbindungen verlaufen von der Mitte nach aussen und dann je vertikal nach unten."} -->
...
<!-- [](https://www.wikidata.org/wiki/Q7835) -->
...
![Politische Karte der Krim mit Städten, Verkehrswegen und geografischen Bezeichnungen. Die Karte zeigt die Halbinsel im Schwarzen Meer, angrenzend an die Ukraine und Russland.](images/image5.png){fig-alt="Karte der Krim mit eingezeichneten Städten, Strassen, Eisenbahnlinien und Landschaftsmerkmalen. Zu sehen sind unter anderem Simferopol, Sewastopol, Jalta, Feodossija, Kertsch und Jewpatorija sowie Gebirge, Küstenlinien und angrenzende Regionen der Ukraine und Russlands."}

<!-- [](https://commons.wikimedia.org/wiki/File:Karte_der_Krim.png) -->
...
### 1.1 Zielsetzung klären {#sec-1.1-zielsetzung-klären}
...
### 1.2 Ethische und rechtliche Rahmenbedingungen {#sec-1.2-ethische-und-rechtliche-rahmenbedingungen}
...
### 1.3 Standards und Infrastruktur festlegen {#sec-1.3-standards-und-infrastruktur-festlegen}
...
### 2.1 Primärerschliessung vs. Nachnutzung {#sec-2.1-primärerschliessung-vs.-nachnutzung}
...
![Screenshot aus Europeana: Metadaten zum “Genozid-Denkmal” in Ejmiacin, Armenien. ](images/image7.png){fig-alt="Screenshot eines Metadateneintrags in Europeana zum Objekt “Genozid-Denkmal” mit Angaben wie “Betreff”, “Datenpartner” oder “Rechtehinweise”."}
...
### 2.2 Kontextualisierung der Quellen {#sec-2.2-kontextualisierung-der-quellen}
...
### 3.1 Technische Standards implementieren {#sec-3.1-technische-standards-implementieren}
...
### 3.2 Beschreibung und Verschlagwortung {#sec-3.2-beschreibung-und-verschlagwortung}
...
### 3.3 KI-Unterstützung und Automatisierung {#sec-3.3-ki-unterstützung-und-automatisierung}
...
### 4.1 Repositorien und Plattformen {#sec-4.1-repositorien-und-plattformen}
...
### 4.2 Versionierung und Historisierung {#sec-4.2-versionierung-und-historisierung}
...
### 5.1 Zielgruppe definieren {#sec-5.1-zielgruppe-definieren}
...
### 5.2 Umgang mit sensiblen und diskriminierenden Inhalten {#sec-5.2-umgang-mit-sensiblen-und-diskriminierenden-inhalten}
...
### 5.3 Technische Strategien {#sec-5.3-technische-strategien}
...
### 5.4 Transparente Dokumentation {#sec-5.4-transparente-dokumentation}
...
### 6.1 Interoperabilität erweitern {#sec-6.1-interoperabilität-erweitern}
...
### 6.2 Zitation und Provenienz {#sec-6.2-zitation-und-provenienz}
...
### 6.3 Nutzungsbedingungen und Lizenzen {#sec-6.3-nutzungsbedingungen-und-lizenzen}
...
### 6.4 Maschinenlesbarer Zugang {#sec-6.4-maschinenlesbarer-zugang}
...
### 6.5 Feedback und Korrekturschleifen {#sec-6.5-feedback-und-korrekturschleifen}
...
### 7.1 Langzeitarchivierung konkret {#sec-7.1-langzeitarchivierung-konkret}
...
### 7.2 Löschung, Rückgabe und Takedown {#sec-7.2-löschung,-rückgabe-und-takedown}
...
### 7.3 Zugriff und Schutz {#sec-7.3-zugriff-und-schutz}
...
Hilfestellungen für weiterführende Fragen, die über die behandelten Themen des Handbuchs hinausgehen.
:::

<!-- ![Hilfestellungen für weiterführende Fragen, die über die behandelten Themen des Handbuchs hinausgehen.](images/image9.png){fig-alt="Das Bild zeigt ein Flussdiagramm zur Navigation bei fachspezifischen Fragen zu Metadaten. Zentral steht das Feld «Ich habe eine fachspezifische Frage». Von dort führen drei Äste zu den Bereichen «Metadaten», «Forschungs- oder Institutionskontexte» und «Spezifische Diskriminierungsformen». Unter «Metadaten» gibt es die Unterpunkte: «Normdaten» (verweist auf Breslau 2019), «Open Data / Commons» (Hahn 2016), «Recht & Lizenzen» (Weitzmann & Klimpel 2016\) und «Kartografische Sammlungen» (Gasser & Hötea 2024). Unter «Forschungs- oder Institutionskontexte» erscheinen: «Kunstmuseen» (Knaus 2019), «Universitätsarchive» (Bruckmann 2024\) und «Kolonialkontexte» (Bruckmann 2024). Unter «Spezifische Diskriminierungsformen» finden sich: «NS-Provenienz» (Baresel-Brand 2019\) und «Sklaverei-Archive» (Ahrndt 2021). Alle Felder sind rechteckig und hellviolett hinterlegt. Unterpunkte sind jeweils direkt mit den entsprechenden Literaturangaben verbunden."} -->

* [ ] Reader for Black Lives Philadephia <https://archivesforblacklives.wordpress.com/wp-content/uploads/2020/11/ardr_202010.pdf>
