...
flowchart LR
  ...
  ZUG --> P5["Phase 5: Publication &amp; Access"]
  P5 --> R5["Practice §5"]
...
Institutional discrimination occurs when internal rules and routines of a specific memory institution systematically disadvantage certain groups. It is often intertwined with structural discrimination. CROSS-REFERENCE
...
<!-- FIXME Glossary is not displayed completely -->
...
%%| fig-cap: "Help for further questions that go beyond the topics covered in the manual."
%%| fig-alt: "Flowchart for guidance on subject-specific questions in archive and metadata research. The central question 'I have a subject-specific question' branches into three areas: metadata, research or institutional contexts, and specific forms of discrimination. 'Metadata' refers to standard data (Breslau 2019), open data/commons (Hahn 2016), law & licenses (Weitzmann & Klimpel 2016), and cartographic collections (Gasser & Hötea 2024). 'Research or institutional contexts' includes art museums (Knaus 2019), university archives (Bruckmann 2024), and colonial contexts (Bruckmann 2024). Under 'Specific forms of discrimination', there are Nazi provenance (Baresel-Brand 2019), slavery archives (Ahrndt 2021), and racism (A4BLiP 2020)."
flowchart LR
    Question["I have a subject-specific question"]

    Question --> SpezMeta["Metadata"]
    ...
    SpecMeta --> StandardData["Standard data"]
    SpezMeta --> OpenData["Open Data / Commons"]
    SpezMeta --> Law["Law & Licenses"]
    SpezMeta --> Maps["Cartographic collections"]

    Standard data --> Breslau["Breslau (2019)"]
    ...
    SpezForschung --> UniArchive["University archives"]
    ...
    SpezDisk --> NSProvenance["NS Provenance"]
    SpezDisk --> Slavery["Slavery Archives"]
    SpezDisk --> Racism["Racism"]
